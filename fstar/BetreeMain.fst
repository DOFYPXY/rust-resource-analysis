...
assume val betree_utils_load_internal_node_fwd
...
assume val betree_utils_store_internal_node_fwd
  :
...
assume val betree_utils_load_leaf_node_fwd
...
assume val betree_utils_store_leaf_node_fwd
...
let rec betree_list_len_fwd (t : Type0) (self : betree_list_t t) : result u64 =
...
assume val core_option_option_unwrap_fwd
...
and betree_internal_flush_back'a
  ...
  :
  result (state & (betree_internal_t & betree_node_id_counter_t))
  =
  let* p =
    betree_list_partition_at_pivot_fwd betree_message_t content
      self.betree_internal_pivot in
