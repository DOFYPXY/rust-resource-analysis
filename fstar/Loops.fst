...
(** [loops::sum] *)
let rec sum_loop_fwd (max : u32) (i : u32) (s : u32) : result u32 =
  if i < max
  then begin
...
(** [loops::clear] *)
let rec clear_loop_fwd_back (v : vec u32) (i : usize) : result (vec u32) =
...
(** [loops::list_mem] *)
let rec list_mem_loop_fwd (x : u32) (ls : list_t u32) : result bool =
  begin match ls with
...
(** [loops::get_elem_mut] *)
let rec get_elem_mut_loop_fwd (x : usize) (ls : list_t usize) : result usize =
  begin match ls with
...
let rec get_elem_mut_loop_back
  (x : usize) (ls : list_t usize) (ret : usize) : result (list_t usize) =
  begin match ls with
  | ListCons y tl ->
    if y = x
    then Return (ListCons ret tl)
...
let rec list_nth_mut_loop_with_id_loop_fwd
  (t : Type0) (i : u32) (ls : list_t t) : result t =
  begin match ls with
  | ListCons x tl ->
    if i = 0
    then Return x
...
let rec list_nth_mut_loop_with_id_loop_back
  (t : Type0) (i : u32) (ls : list_t t) (ret : t) : result (list_t t) =
  begin match ls with
  | ListCons x tl ->
    if i = 0
    then Return (ListCons ret tl)
